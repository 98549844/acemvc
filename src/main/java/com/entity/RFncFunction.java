...
/**
 * @author: Kalam
 * @time: 2022/08/18 10:36
 * @description:
 */
@EntityListeners(AuditingEntityListener.class)
@Table(name = "R_FNC_FUNCTION", uniqueConstraints = {@UniqueConstraint(name = "R_FNC_PK", columnNames = {"UPF_USER_ID", "FNC_PARENT_FUNC_ID", "FNC_FUNC_ID"})})
@Entity
public class RFncFunction /*extends RFncFunctionKey*/ implements Serializable {

    public RFncFunctionKey getrFncFunctionKey() {
        return rFncFunctionKey;
    }

    public void setrFncFunctionKey(RFncFunctionKey rFncFunctionKey) {
        this.rFncFunctionKey = rFncFunctionKey;
    }

    @EmbeddedId
    private RFncFunctionKey rFncFunctionKey;
